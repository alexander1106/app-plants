...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-11-2025 a las 19:14:42
...
CREATE TABLE `cuidados` (
  `id` int(11) NOT NULL,
  `riego` enum('una vez por semana','dos veces por semana','una vez al mes','cada 15 dias','frecuente','ocasional','Tres veces por semana','''Una vez cada 15 días','1-2 vez por semana') DEFAULT NULL,
  `luz_solar` enum('pleno sol','sombra parcial','sombra total','luz filtrada') DEFAULT NULL,
  `temperatura_ideal` varchar(50) DEFAULT NULL,
  `poda` enum('anual','semestral','trimestral','ocasional') DEFAULT NULL,
  `abonado` enum('anual','semestral','trimestral','mensual','ocasional') DEFAULT NULL,
  `descripcion` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `cuidados` (`id`, `riego`, `luz_solar`, `temperatura_ideal`, `poda`, `abonado`, `descripcion`) VALUES
(1, 'una vez por semana', 'pleno sol', '18-32°C', 'anual', 'semestral', NULL),
(2, 'dos veces por semana', 'sombra parcial', '20-30°C', 'semestral', 'anual', NULL),
(3, 'una vez al mes', 'pleno sol', '15-28°C', 'anual', 'anual', NULL),
(4, 'Tres veces por semana', 'sombra parcial', '22-32°C', 'trimestral', 'semestral', NULL),
(5, '\'Una vez cada 15 días', 'pleno sol', '18-30°C', 'semestral', 'semestral', NULL),
(6, 'ocasional', 'sombra parcial', '16-25°C', 'anual', 'anual', NULL),
(7, 'una vez por semana', 'pleno sol', '10-22°C', 'anual', 'trimestral', NULL),
(8, 'dos veces por semana', 'pleno sol', '25-32°C', 'semestral', 'semestral', NULL),
(9, 'una vez al mes', 'sombra total', '12-20°C', 'anual', 'anual', NULL),
(10, 'frecuente', 'pleno sol', '20-32°C', 'trimestral', 'trimestral', NULL),
(11, '1-2 vez por semana', 'pleno sol', '5-32°C', 'ocasional', 'ocasional', NULL),
(12, 'ocasional', 'pleno sol', '0-32°C', 'ocasional', 'ocasional', NULL);
...
(19, 'H.Lév.', '1911-01-01'),
(20, 'Mill.', '1768-04-16'),
(21, 'Takenoshin Nakai', '1914-01-01'),
(22, ' Teofrasto', NULL),
(23, 'Ferdinand von Mueller', '1863-01-01'),
(24, 'Scopoli', '1772-01-01'),
(25, ' Adrien René Franchet', '1899-01-01'),
(26, 'Wall. (William Griffith)', '1830-01-01'),
(27, 'Joseph Maiden y William Blakely', '1929-01-01'),
(28, 'Joseph Maiden', '1904-01-01'),
(29, 'Maxim. ex Miq', '1865-01-01');
...
CREATE TABLE `especie` (
  ...
  `cuidados_id` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `especie` (`id`, `nombre_cientifico`, `nombres_comunes`, `descripcion`, `genero_id`, `region_id`, `descubrimiento_id`, `cuidados_id`) VALUES
(1, 'Acer_Capillipes', 'Corteza de serpiente', 'Especie del género Acer.', 152, 1, 1, 2),
(2, 'Acer_Circinatum', 'Arce circinado', 'Especie del género Acer.', 152, 1, 2, 8),
(3, 'Acer_Mono', 'Arce mono', 'Especie del género Acer.', 152, 1, 3, 6),
(4, 'Acer_Opalus', 'Acirón', 'Especie del género Acer.', 152, 1, 4, 3),
(5, 'Acer_Palmatum', 'Arce japonés', 'Especie del género Acer.', 152, 1, 5, 2),
(6, 'Acer_Pictum', 'Arce pintado', 'Especie del género Acer.', 152, 1, 6, 11),
(7, 'Acer_Platanoids', 'Arce plátanoide', 'Especie del género Acer.', 152, 1, 7, 11),
(8, 'Acer_Rubrum', 'Arce rojo', 'Especie del género Acer.', 152, 1, 7, 11),
(9, 'Acer_Rufinerve', 'Arce rufinerve', 'Especie del género Acer.', 152, 1, 9, 11),
(10, 'Acer_Saccharinum', 'Arce plateado', 'Especie del género Acer.', 152, 1, 7, 11),
(11, 'Alnus_Cordata', 'Aliso italiano', 'Especie del género Alnus.', 153, 1, 11, 2),
(12, 'Alnus_Maximowiczii', ' Aliso montano', 'Especie del género Alnus.', 153, 1, 12, 2),
(13, 'Alnus_Rubra', 'Aliso rojo', 'Especie del género Alnus.', 153, 1, 13, 11),
(14, 'Alnus_Sieboldiana', 'Aliso Siebold', 'Especie del género Alnus.', 153, 1, 14, 7),
(15, 'Alnus_Viridis', 'Aliso verde', 'Especie del género Alnus.', 153, 1, 15, 2),
(16, 'Arundinaria_Simonii', 'Bambú de Simon', 'Especie del género Arundinaria.', 154, 6, 16, 6),
(17, 'Betula_Austrosinensis', 'Abedul chino', 'Especie del género Betula.', 155, 1, 17, 12),
(18, 'Betula_Pendula', 'Abedul péndulo', 'Especie del género Betula.', 155, 1, 18, 11),
(19, 'Callicarpa_Bodinieri', 'Arbusto de dulces', 'Especie del género Callicarpa.', 156, 6, 19, 11),
(20, 'Castanea_Sativa', 'Castaño común', 'Especie del género Castanea.', 157, 3, 20, 11),
(21, 'Celtis_Koraiensis', 'Almez coreano', 'Especie del género Celtis.', 158, 1, 21, NULL),
(22, 'Cercis_Siliquastrum', 'Árbol del amor', 'Especie del género Cercis.', 159, 3, 22, 1),
(23, 'Cornus_Chinensis', 'Cornejo chino', 'Especie del género Cornus.', 160, 1, 24, 8),
(24, 'Cornus_Controversa', 'Cornejo controversial', 'Especie del género Cornus.', 160, 1, 23, 1),
(25, 'Cornus_Macrophylla', 'Cornejo de hojas grandes', 'Especie del género Cornus.', 160, 1, 26, 2),
(26, 'Cotinus_Coggygria', 'Árbol de las pelusas', 'Especie del género Cotinus.', 161, 3, 24, 2),
(27, 'Crataegus_Monogyna', 'Espino albar', 'Especie del género Crataegus.', 162, 1, NULL, 11),
(28, 'Cytisus_Battandieri', 'Retama marroquí', 'Especie del género Cytisus.', 163, 9, NULL, NULL),
(29, 'Eucalyptus_Glaucescens', 'Eucalipto glauco', 'Especie del género Eucalyptus.', 164, 6, 27, 6),
(30, 'Eucalyptus_Neglecta', 'Eucalipto neglecta', 'Especie del género Eucalyptus.', 164, 6, 28, 6),
(31, 'Eucalyptus_Urnigera', 'Eucalipto urnigera', 'Especie del género Eucalyptus.', 164, 6, NULL, NULL),
(32, 'Fagus_Sylvatica', 'Haya europea', 'Especie del género Fagus.', 165, 1, NULL, NULL),
(33, 'Ginkgo_Biloba', 'Ginkgo', 'Única especie viva del género Ginkgo.', 39, 1, NULL, NULL),
(34, 'Ilex_Aquifolium', 'Acebo común', 'Especie del género Ilex.', 166, 1, NULL, NULL),
(35, 'Ilex_Cornuta', 'Acebo cornudo', 'Especie del género Ilex.', 166, 6, NULL, NULL),
(36, 'Liquidambar_Styraciflua', 'Árbol del ámbar', 'Especie del género Liquidambar.', 167, 1, NULL, NULL),
(37, 'Liriodendron_Tulipifera', 'Árbol de tulipán', 'Especie del género Liriodendron.', 168, 1, NULL, NULL),
(38, 'Lithocarpus_Cleistocarpus', 'Roble de piedra cleistocarpus', 'Especie del género Lithocarpus.', 169, 6, NULL, NULL),
(39, 'Lithocarpus_Edulis', 'Roble de piedra japonés', 'Especie del género Lithocarpus.', 169, 6, NULL, NULL),
(40, 'Magnolia_Heptapeta', 'Magnolia heptapeta', 'Especie del género Magnolia.', 170, 6, NULL, NULL),
(41, 'Magnolia_Salicifolia', 'Magnolia de hojas de sauce', 'Especie del género Magnolia.', 170, 6, NULL, NULL),
(42, 'Morus_Nigra', 'Moral negro', 'Especie del género Morus.', 74, 3, NULL, NULL),
(43, 'Olea_Europaea', 'Olivo', 'Especie del género Olea.', 171, 3, NULL, NULL),
(44, 'Phildelphus', 'Filadelfo', 'Especie del género Philadelphus.', 172, 1, NULL, NULL),
(45, 'Populus_Adenopoda', 'Álamo adenopoda', 'Especie del género Populus.', 173, 1, NULL, NULL),
(46, 'Populus_Grandidentata', 'Álamo de dientes grandes', 'Especie del género Populus.', 173, 1, NULL, NULL),
(47, 'Populus_Nigra', 'Álamo negro', 'Especie del género Populus.', 173, 1, NULL, NULL),
(48, 'Prunus_Avium', 'Cerezo dulce', 'Especie del género Prunus.', 174, 1, NULL, NULL),
(49, 'Prunus_X_Shmittii', 'Cerezo híbrido Shmittii', 'Especie del género Prunus.', 174, 1, NULL, NULL),
(50, 'Pterocarya_Stenoptera', 'Nogal alado chino', 'Especie del género Pterocarya.', 175, 6, NULL, NULL),
(51, 'Quercus_Afares', 'Encina Afares', 'Especie del género Quercus.', 176, 3, NULL, NULL),
(52, 'Quercus_Agrifolia', 'Encina californiana', 'Especie del género Quercus.', 176, 3, NULL, NULL),
(53, 'Quercus_Alnifolia', 'Encina chipriota', 'Especie del género Quercus.', 176, 3, NULL, NULL),
(54, 'Quercus_Brantii', 'Roble iraní', 'Especie del género Quercus.', 176, 3, NULL, NULL),
(55, 'Quercus_Canariensis', 'Quejigo andaluz', 'Especie del género Quercus.', 176, 3, NULL, NULL),
(56, 'Quercus_Castaneifolia', 'Roble castaño', 'Especie del género Quercus.', 176, 6, NULL, NULL),
(57, 'Quercus_Cerris', 'Cerro roble', 'Especie del género Quercus.', 176, 3, NULL, NULL),
(58, 'Quercus_Chrysolepis', 'Roble de oro', 'Especie del género Quercus.', 176, 1, NULL, NULL),
(59, 'Quercus_Coccifera', 'Coscoja', 'Especie del género Quercus.', 176, 3, NULL, NULL),
(60, 'Quercus_Coccinea', 'Roble escarlata', 'Especie del género Quercus.', 176, 1, NULL, NULL),
(61, 'Quercus_Crassifolia', 'Roble crassifolia', 'Especie del género Quercus.', 176, 1, NULL, NULL),
(62, 'Quercus_Crassipes', 'Roble crassipes', 'Especie del género Quercus.', 176, 1, NULL, NULL),
(63, 'Quercus_Dolicholepis', 'Roble dolicholepis', 'Especie del género Quercus.', 176, 6, NULL, NULL),
(64, 'Quercus_Ellipsoidalis', 'Roble ellipsoidalis', 'Especie del género Quercus.', 176, 1, NULL, NULL),
(65, 'Quercus_Greggii', 'Roble Greggii', 'Especie del género Quercus.', 176, 1, NULL, NULL),
(66, 'Quercus_Hartwissiana', 'Roble Hartwiss', 'Especie del género Quercus.', 176, 6, NULL, NULL),
(67, 'Quercus_Ilex', 'Encina', 'Especie del género Quercus.', 176, 3, NULL, NULL),
(68, 'Quercus_Imbricaria', 'Roble imbricado', 'Especie del género Quercus.', 176, 1, NULL, NULL),
(69, 'Quercus_Infectoria_sub', 'Roble infectoria subsp.', 'Especie del género Quercus.', 176, 3, NULL, NULL),
(70, 'Quercus_Kewensis', 'Roble Kewensis', 'Especie del género Quercus.', 176, 3, NULL, NULL),
(71, 'Quercus_Nigra', 'Roble negro', 'Especie del género Quercus.', 176, 1, NULL, NULL),
(72, 'Quercus_Palustris', 'Roble de los pantanos', 'Especie del género Quercus.', 176, 1, NULL, NULL),
(73, 'Quercus_Phellos', 'Roble sauce', 'Especie del género Quercus.', 176, 1, NULL, NULL),
(74, 'Quercus_Phillyraeoides', 'Roble phillyraeoides', 'Especie del género Quercus.', 176, 3, NULL, NULL),
(75, 'Quercus_Pontica', 'Roble póntico', 'Especie del género Quercus.', 176, 3, NULL, NULL),
(76, 'Quercus_Pubescens', 'Roble pubescente', 'Especie del género Quercus.', 176, 3, NULL, NULL),
(77, 'Quercus_Pyrenaica', 'Rebollo', 'Especie del género Quercus.', 176, 3, NULL, NULL),
(78, 'Quercus_Rhysophylla', 'Roble rojo mexicano', 'Especie del género Quercus.', 176, 1, NULL, NULL),
(79, 'Quercus_Rubra', 'Roble rojo americano', 'Especie del género Quercus.', 176, 1, NULL, NULL),
(80, 'Quercus_Semecarpifolia', 'Roble Himalayo', 'Especie del género Quercus.', 176, 6, NULL, NULL),
(81, 'Quercus_Shumardii', 'Roble Shumard', 'Especie del género Quercus.', 176, 1, NULL, NULL),
(82, 'Quercus_Suber', 'Alcornoque', 'Especie del género Quercus.', 176, 3, NULL, NULL),
(83, 'Quercus_Texana', 'Roble texano', 'Especie del género Quercus.', 176, 1, NULL, NULL),
(84, 'Quercus_Trojana', 'Roble troyano', 'Especie del género Quercus.', 176, 3, NULL, NULL),
(85, 'Quercus_Variabilis', 'Roble variabilis', 'Especie del género Quercus.', 176, 6, NULL, NULL),
(86, 'Quercus_Vulcanica', 'Roble volcánico', 'Especie del género Quercus.', 176, 3, NULL, NULL),
(87, 'Quercus_x_Hispanica', 'Roble híbrido hispánico', 'Especie del género Quercus.', 176, 3, NULL, NULL),
(88, 'Quercus_x_Turneri', 'Roble Turner', 'Especie del género Quercus.', 176, 3, NULL, NULL),
(89, 'Rhododendron_x_Russellianum', 'Rododendro Russellianum', 'Especie híbrida del género Rhododendron.', 177, 6, NULL, NULL),
(90, 'Salix_Fragilis', 'Sauce quebradizo', 'Especie del género Salix.', 178, 1, NULL, NULL),
(91, 'Salix_Intergra', 'Sauce integra', 'Especie del género Salix.', 178, 1, NULL, NULL),
(92, 'Sorbus_Aria', 'Serbal común', 'Especie del género Sorbus.', 179, 1, NULL, NULL),
(93, 'Tilia_Oliveri', 'Tilo de Oliver', 'Especie del género Tilia.', 180, 1, NULL, NULL),
(94, 'Tilia_Platyphyllos', 'Tilo de hoja ancha', 'Especie del género Tilia.', 180, 1, NULL, NULL),
(95, 'Tilia_Tomentosa', 'Tilo plateado', 'Especie del género Tilia.', 180, 1, NULL, NULL),
(96, 'Ulmus_Bergmanniana', 'Olmo de Bergmann', 'Especie del género Ulmus.', 181, 1, NULL, NULL),
(97, 'Viburnum_Tinus', 'Durillo', 'Especie del género Viburnum.', 182, 3, NULL, NULL),
(98, 'Viburnum_x_Rhytidophylloides', 'Viburno híbrido', 'Especie del género Viburnum.', 182, 1, NULL, NULL),
(99, 'Zelkova_Serrata', 'Zelkova japonés', 'Especie del género Zelkova.', 183, 1, NULL, NULL);
...
--
-- Volcado de datos para la tabla `especie_propiedad_quimica`
--

INSERT INTO `especie_propiedad_quimica` (`especie_id`, `propiedad_id`, `concentracion`, `comentario`) VALUES
(13, 6, NULL, NULL),
(26, 1, NULL, NULL);
...
--
-- Volcado de datos para la tabla `propiedades_quimicas`
--

INSERT INTO `propiedades_quimicas` (`id`, `nombre`, `descripcion`) VALUES
(1, 'Toxico', NULL),
(2, 'antioxidante', NULL),
(3, 'analgésico', NULL),
(4, 'Antinflamatorio', NULL),
(5, 'Antibiotico', NULL),
(6, 'Pigmento', NULL);
...
INSERT INTO `uso` (`id`, `nombre`, `descripcion`) VALUES
(1, 'ornamental', 'Uso ornamental en jardines, parques y áreas verdes por su estética y capacidad de adaptación.'),
(2, 'medicinal', 'Empleo en remedios tradicionales o extracción de compuestos con propiedades terapéuticas.'),
(3, 'cosmetico', 'Utilización en la elaboración de productos cosméticos como cremas, aceites y fragancias.'),
(4, 'industrial', 'Aplicación en industrias para obtención de fibras, aceites, resinas o subproductos derivados.'),
(5, 'alimenticio', 'Uso como alimento humano o animal, incluyendo frutos, hojas, semillas o derivados procesados.'),
(6, 'ecologico', 'Función ecológica como protección del suelo, restauración ambiental, captura de carbono o refugio de fauna.'),
(7, 'agricola', 'Aprovechamiento en sistemas agroforestales, cercos vivos, mejora del suelo o cultivos complementarios.'),
(8, 'cultura', 'Importancia cultural, simbólica o tradicional en pueblos, festividades o prácticas ancestrales.'),
(9, 'madera', 'Producción de madera para construcción, carpintería, muebles o artesanías.'),
(10, 'artesania', 'Empleo en la elaboración de artesanías, objetos decorativos y piezas utilitarias mediante el aprovechamiento de sus fibras, corteza, savia, semillas o partes vegetales.');
...
--
-- Volcado de datos para la tabla `uso_especie`
--

INSERT INTO `uso_especie` (`especie_id`, `uso_id`, `comentario`) VALUES
(1, 1, NULL),
(2, 1, NULL),
(2, 10, NULL),
(3, 1, NULL),
...
ALTER TABLE `especie`
  ...
  ADD KEY `cuidados_id` (`cuidados_id`);
...
ALTER TABLE `especie`
  ...
  ADD CONSTRAINT `especie_ibfk_4` FOREIGN KEY (`cuidados_id`) REFERENCES `cuidados` (`id`);
